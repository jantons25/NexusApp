...
import zentraImage from "../assets/nexus-zona-flex.jpeg"; // Ajusta la ruta según donde guardes la imagen
    ...
    <div className="bg w-full h-screen flex justify-center items-center p-4">
      <div className="flex max-w-5xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(252, 213, 53, 0.85), rgba(218, 165, 32, 0.85)), url(${zentraImage})`,
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-[#FCD535] text-2xl font-bold">N</span>
              </div>
              <h2 className="text-white text-2xl font-bold">NexusApp</h2>
            </div>
          </div>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FCD535] focus:border-transparent transition"
                />
                {errors.username && (
              ...
              <button
                type="submit"
                className="w-full bg-[#FCD535] text-white font-semibold py-3 rounded-lg hover:bg-[#fcd435d1] transition duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Sign In
              </button>
            </form>
